...
builder.Services.AddSwaggerGen(c => {
    c.SwaggerDoc("v1", new()
    {
        Contact = new()
        {
            Email = "robin.rosculete.860@my.csun.edu",
            Name = "Robin Rosculete",
...
builder.Services.AddDbContext < Com584dbContext>(optionsBuilder =>
...
builder.Services.AddIdentity<WorldCitiesUser, IdentityRole>()
    .AddEntityFrameworkStores<Com584dbContext>();
